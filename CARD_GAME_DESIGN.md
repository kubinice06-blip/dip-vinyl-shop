...
**相生（自我充能，循環：經典 → 冷門 → 入耳 → 經典）**——宣告屬性接續上一回合者觸發：
- **【品味拓荒】** classic → obscurity ｜ **【閾值突破】** obscurity → accessibility ｜ **【前衛收編】** accessibility → classic
- 充能：2 連鎖 **氣勢 +1**；3 連鎖 **氣勢 +2**；**第 4 環起不再充能**（須斷掉重鋪，避免無腦循環刷氣勢）；中斷或屬性重複 → 連鎖歸零。

**相剋（對手壓制，循環：冷門 剋 經典 → 經典 剋 入耳 → 入耳 剋 冷門）**：
- **【品味突襲】** obscurity 剋 classic ｜ **【大眾共鳴】** classic 剋 accessibility ｜ **【降維打擊】** accessibility 剋 obscurity
