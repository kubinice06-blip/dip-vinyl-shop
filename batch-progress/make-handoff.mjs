...
const EXTRA = {
  ...
  c49: {
    ownerDecisions: [
      ...
      '【陳芬蘭《陳芬蘭典藏集(1)》年份未定】研究稿記載四說並存（1956 年「8 歲」說與 1958 年原曲時序矛盾、該數字可疑；另有 1958 AL271／1959／1960 三說）。hook 層的 note 指派「發行年寫 1958 年」，但該卡 facts 沒有任何可繫到 1958 的事件，寫作層因此在正文完全不寫發行年（只寫生年 1948 與 14 歲赴日），未自行擇一——事實紀律勝過施工圖指派，是正確處理。本機請裁定該卡的年份，卡片欄位目前仍是策展層的 suggestedYear。',
    ...
    poolIssues: [
      ...
      '【《台灣流行音樂百張最佳專輯》的逐卡處理】同一份榜單在三張卡有三種處理，依「未具名出處的榜單不寫」逐卡判斷：沈文程《心事誰人知》保留第 81 名，因該卡 facts 帶有主辦者（1993 年台大學生吳清聖、馬世芳等人發起評選）且正文已具名；洪榮宏《行船人的愛》第 99 名與江蕙《酒後的心聲》第 28 名整條捨去，改用金曲獎收尾，因那兩張自身的 facts 沒有主辦者。本機若要統一補回，請先替後兩張補上具名來源。',
