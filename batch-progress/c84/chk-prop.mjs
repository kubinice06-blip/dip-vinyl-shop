// c-84 提案檢查。用法：node batch-progress/c84/chk-prop.mjs [組別…]
...
for (const g of groups) {
  const f = path.join(ROOT, `batch-progress/c84/prop-${g}.json`);
  ...
  p.forEach(x => {
    ...
    if (x.releaseType === 'Compilation') {
      ...
      // §5.5 asia-mini-album 白名單卡（2026-09-03 c-84 加）：EP 要收就得帶與 §5.6 同等的舉證，
