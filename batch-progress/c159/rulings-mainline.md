...
## 第 1620-R 條（主線）：**c-159 寫作 b 組交件——16 張 219–239，零張出界；初稿 16／16 全部撞破 240，低估 70–100**

**主線逐項覆核全過**：兩張無串流卡（Al Green／Bunnett）正文**零串流零試聽**且**不空**
（各有錄音期／編制／發行／成績）；**載體只在 Al Green 寫「同日另發一張黑膠」、其餘 15 張零黑膠**；
**卡崔娜 0、重新配器 0、輪流／互不重疊 0**；
**Cassandra Wilson 寫「三位鼓手的軌次互有重疊」、Don Byron 寫「兩位歌手各唱四軌並在第 6 軌同時到場」**
——**兩張都正面寫出重疊，正確。**
（三筆掃到 `Billboard` 的都是**官方榜名**：Billboard 200 與 Top Jazz Albums，**不是樂評媒體名，合規。**）

⚠⚠ **字數：本組是本線至今最極端的一次單向低估——16／16 全部撞破 240，低估 70–100 字元**
（第一波五張實測 285–310，估值當 210；Osby 310、Al Green 308、Lovano《Joyous Encounter》304）。
**形狀再次應驗：撞得最兇的就是要點名五、六個拉丁專名那幾張。**
**代理的建議值得採納並寫進後批派工詞**：
**「爵士批次的專名上限 3 個」對這一段完全不夠，實際要壓到 2–3 個，
並且整段捨去錄音室／母帶／客座三類。**

⚠ **但幅度依舊不可繼承**：同一批的 a 組中位只有 **+22**、b 組卻是 **+70～+100**。
**第 1504-B 條再次成立。**

## 第 1620-S 條（主線，**裁定；改了一張出稿**）：**《Remember: A Tribute to Wes Montgomery》的樂評媒體名拿掉**

寫作 b 組具名寫了 **Penguin Guide to Jazz** 的評語，理由是 note 明文指定＋`writer-base.md` 的**例外二**。
**主線裁定：拿掉媒體名、保留評語內容。已改檔。**

依據是例外二自己的判準（`writer-base.md` 第 231 行）：
**「把樂評整條拿掉之後，這張卡還剩不剩得下一個故事？」**
——**這張剩得下，而且剩很多**：十四歲那年父親帶他去見 Wes Montgomery（他早已把對方的獨奏整段背下）、
Martino 自己說 Montgomery 最有意思的是情感上的詮釋、1972 年的《The Visit!》就已經致敬過同一個人、
2005 年 8 月在紐約 Avatar Studios 錄成、十軌裡有五首是 Montgomery 自己寫的曲子。
**→ 屬「剩得下 → 照舊不寫」那一支。**

⚠ **另一層判準也不支持具名**：例外二允許具名的是
**「那條定位非得靠出處才成立時（年度榜、名人堂、票選、十年百大）」**
——**本例寫的是評語內容（「驚人的翻身」「從來沒有比現在更好」），不是需要出處撐住的排名。**
**評語內容不具名照樣成立，改成「當年的評論稱它是…」即可。**

**實際改動**：`Penguin Guide to Jazz 稱它是` → `當年的評論稱它是`，**236 → 219 字，仍在區間內**，
`fix-spacing` 待補 0。

⚠ **這與 c-158 a 組的先例一致**：那一批的 Ron Carter《The Golden Striker》同樣**無榜無獎無認證**、
同樣用當年評論收尾，**但代理自己就沒有寫媒體名**（第 1560-AH 條第 4 點）。
**兩張現在處置相同。**

**→ 後批通則（收緊一句）**：**例外二的「可以具名」只適用於年度榜／名人堂／票選／十年百大這類
「去掉出處就變成無意義數字」的定位。單純的評語內容一律不具名。**
**note 若明文指定具名，而該卡不屬上述形狀，以 `writer-base.md` 為準。**

## 第 1620-T 條（主線，裁定權下放範圍內）：**寫作 b 組為字數整格捨去的四處，全部維持**

1. **Al Green**：〈Perfect to Me〉的 Adult R&B 第 27 名整格捨去，**只留專輯榜第 50 名**；
   編制只留 Leroy Hodges 的貝斯與八人 New Memphis Strings，**和聲三人捨去**
   （**國際版早一天與同日黑膠兩項都保住**——那兩項是這張最硬的）。
2. **Jane Bunnett**：Howard Johnson 低音號第 1–6 軌捨去；**封面兩欄、changüí 樂社、Juno 得獎都在。**
3. **Lovano《Streams of Expression》**：hook 佔 61 字，**aulochrome 那句（note 自己標「（一句）」的次要軼事）整格捨去**，
   正文留 Schuller 主導、他是 1950-03-09 那場的法國號、組曲結構。
   另《Joyous Encounter》把前作盤名（31 字元）改寫成「前一年那張抒情曲集」；Rubalcaba 的封面畫作者捨去。

**全部可逆、全部保住該卡最硬的那一格。維持。**
⚠ **第 3 點的做法值得記**：**note 自己標「（一句）」的次要軼事，是壓字時第一個該捨的**——列為後批通則。

## 第 1620-U 條（主線，**兩處派工詞的小瑕疵，代理都處理對了**）

1. ⚠ **我在派工詞寫 `desc2:Al Green|Everything's OK`（直引號），輸入檔的 key 是彎引號 `Everything’s OK`。**
   代理**照輸入檔逐字複製，正確。**
   **→ 主線自律：派工詞引用 key 時，一律從輸入檔複製，不要手打。**
   （⚠ 這一條在本線是真的會出事的——`chk-prop` 與 `qa-batch` 都用 key 做集合比對。）
2. **我寫「Bunnett 的 2005 年 Urban Music Award 入圍 note 已分開寫」——實際 note 未提、只在 `facts[3]`。**
   代理照 note 只寫 Juno 得獎，**無事實損失。**
