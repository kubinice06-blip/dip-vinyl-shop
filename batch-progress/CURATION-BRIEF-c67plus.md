...
- **實掃 `seed_cards.json` 全檔**，查「這張碟池中有沒有」。日文藝人要三種寫法都查（假名／漢字／羅馬拼音）。
  **⚠ 2026-09-04 更正：本節原本寫「同一藝人池中上限 3 張，達到就不收」——那條作廢。**
  店主明確表示「並沒有一個人只限三張這種限制」。它只寫在這份簡報裡，`ALBUM_ONBOARDING.md` 沒有、
  任何腳本也都沒有在檢查，而池中 Miles Davis 41 張、John Williams 9 張——**它從來就不是卡池規則**。
  **要擋的只有真撞卡：同一張碟池中已經有了就不收。** 同一位藝人收幾張，依那幾張碟本身值不值得收來判斷。
  （連帶：第 72 條「`Various Artists` 不計入藝人上限」失去適用對象，VA 照它本身該不該收來判斷，仍要過 §5.6。）
  **受這條錯誤規則影響而被割捨的候選見裁定第 150 條，可以撈回來。**
