...
const props = JSON.parse(fs.readFileSync(path.join(ROOT, 'batch-progress/c64/prop-b.json'), 'utf8'));
const MBID = /\b(\d{9,})\b/;
const out = {};
...
fs.writeFileSync(path.join(ROOT, 'batch-progress/c64/apple-art.json'), JSON.stringify(out, null, 1));
