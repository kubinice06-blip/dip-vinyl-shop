...
## 第 648 條（主線 2026-09-16，writer-1 交件後）：**「廠牌自己點名主力」不算暢銷宣稱——可以寫，但要寫成「廠牌當時怎麼說」**

writer-1 把《Always Something There》裡 **Mel Fuhrman 點名它是那一季四張主力之一**那句拿掉了，
理由是第 641 條「不得暗示暢銷或大賣」是硬限制。**判斷方向是對的（有疑慮時收斂），但這一句其實可以寫。**

**釐清**：第 641 條擋的是**「沒有榜位證據卻暗示它賣得好」**。
**廠牌總經理在同期紙本上說「這是我們這季的四張主力」是一則有出處的事實陳述**
——它講的是**廠牌當時怎麼押寶**，不是銷售結果。**寫法：寫成「廠牌當時怎麼說」，不得轉成「這張很暢銷」。**
本次不回頭改稿（writer-1 已交件、字數已排滿），**c-143 起的派工信要帶這條**。

**out-1 20 筆驗收**：字數 221–238、首句逐字為 hook、QA 標記 0。
