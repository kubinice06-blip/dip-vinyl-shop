# 策展簡報：日本爵士獨立廠牌線 jp-2（c-183…c-197，15 批 547 張）
...
剔除**池中已有 167／外國藝人的日本壓片 83／1990 年後 140／無年份 8** → **547 張，每批 37，15 批**。
...
1. ⚠ **`poolRecheck` 已標出 6 筆「確定撞池」**（c-186 1、c-188 1、c-189 1、c-191 2、c-192 1）
