// c-118 提案檢查。用法：node batch-progress/c118/chk-prop.mjs [組別…]
...
for (const g of groups) {
  const f = path.join(ROOT, `batch-progress/c118/prop-${g}.json`);
  ...
  p.forEach(x => {
    ...
    if (x.releaseType === 'Compilation') {
      ...
      // §5.5 electronic 白名單（照 c-97 的分支原樣搬過來；c-116／c-117 那條線沒有白名單所以沒帶）：
