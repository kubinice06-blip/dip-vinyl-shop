// c-181 提案檢查。用法：node batch-progress/c181/chk-prop.mjs [組別…]
...
for (const g of groups) {
  const f = path.join(ROOT, `batch-progress/c181/prop-${g}.json`);
  ...
  p.forEach(x => {
    ...
    // 2026-09-21（第 1860-B 條）：日文分隔符 `〜`(U+301C)／`～`(U+FF5E)／`＝`(U+FF1D)
