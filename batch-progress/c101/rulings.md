...
## （主線追加）第 7 條：**a 組 unavailable 是 17 張不是 16 張，救回 12 張** —— 試聽 21/45 → 37/45

| 卡 | 正解 | 落空原因 |
|---|---|---|
| FF IV | jp 61052896（44 軌，六店） | 卡片日文／Apple 英文 |
| FF VI | jp 62447175（61 軌，六店） | 同上 |
| 聖剣伝説 Legend of Mana | jp 251753897（55 軌，**只有 jp**） | 尾綴改英文括號 |
| Chrono Cross | jp 1435281114（67 軌） | ⚠ **卡片英文／Apple 日文——方向與 FF 兩張相反** |
| Actraiser | 276661629（19 軌，六店） | 盤名被包進「Yuzo Koshiro Best Selection, Vol. 1」 |
| Bare Knuckle | 1509127675（22 軌，六店） | **盤名整個換成《Streets of Rage》**（歐美版遊戲名） |
| NieR Gestalt & Replicant | jp 366643025（43 軌） | ⚠ **掛 SQUARE ENIX MUSIC** |
| ペルソナ3 | jp 1546593202（58 軌） | ⚠ **掛アトラスサウンドチーム** |
| ペルソナ5 | jp 1226946448（110 軌） | 同上＋**三種不同的引號** |
| 聖剣伝説2 | 205700367（44 軌，六店） | **盤名整個換成《Secret of Mana》** |
| 月下の夜想曲 | jp 1459349587（33 軌） | ⚠ **掛悪魔城ドラキュラ サウンドチーム**＋羅馬轉寫 |
| Romancing Sa・Ga | 166889681（38 軌，六店） | **全形中點「・」／ASCII「-」／半形中点「･」三種寫法** |

**真的沒有 5 張**：Super Mario 64、時のオカリナ、ムジュラの仮面（任天堂三張是四個藝人實體×六店面全空）、
Kingdom Hearts 2002（只有 HD ReMIX 合輯，全掛 Various Artists）、クロノ・トリガー 1995（只有 DS 版 78 軌）。

## 第 8 條：**裁定 166 的反例——Apple 把碟掛在「發行商／音樂團隊」而不是作曲家**

本組**四張**是這個原因落空：NieR（SQUARE ENIX MUSIC）、ペルソナ3／5（アトラスサウンドチーム）、
月下（悪魔城ドラキュラ サウンドチーム）。**作曲家的藝人頁目錄端點看不到，搜尋端點才看得到。**

第 166 條說「search 漏碟就打藝人頁」，**這一條說反過來也會發生**——連同裁定 173，
現在的結論是：**兩個端點都要跑，而且「藝人頁查無」在日本遊戲／動畫原聲上特別不可靠**，
因為掛名主體常常是團隊或發行商，不是作曲家本人。

## 第 9 條：**兩張 ready 的軌數不是原盤軌數，一張策展層的「查無」不成立**

- **FF XII**：Apple 98 軌是**數位版**，**原盤 CD 是 100 軌**——缺的是第四片第 19／20 軌
  〈Kiss Me Good-Bye〉與〈交響詩「希望」〉。**卡單的 `trackCount=98` 不是原盤軌數**，已鎖 `originalTrackCount=100`。
- **LIVE A LIVE**：Apple 的「(再発売)」43 軌是 **2012 SQEX-10308 加曲版**，**原盤 41 軌**
  （尾端多〈Battlissimo〉〈Forgotten Wings〉）。依裁定 140 判加曲版、採用，已鎖 `originalTrackCount=41`。
- **VAGRANTSTORY**：策展層 rulings §9 把它列進「12 張 Apple 查無」——**不成立**，
  jp 647861379 是原盤、57 軌全對。

另六張逐軌**零差異**（FF VII／Xenogears／FFT／FF XII／P5／Vagrant Story）；
年份偏差三處全是**重出日**（FF IX→2004 SQEX-10009、FFT→2007-05-30 XW 數位、FF XII→2012 SQEX-10343），MB 都有對應 release。

## 第 10 條：**a 組擋下策展層 15 處，其中 8 處與來源相反**
...
月下「本批再發最多」（SH2 18 > 17）｜SH2「唯一日歐同日」（NieR:Automata 2017-03-29 JP+GB 同日）。

**這八處的共同形狀值得記**：**全都是「最／唯一／第一」而且全都可以用同一批資料自己反證**——
策展層手上就有那些數字，只是沒有互相比對。

另更正三處事實：ムジュラ 2015 TSCM-0029 是 **3DS 重製版原聲**不是重出；
...
- Xenogears／Bare Knuckle 的 MB artist-credit 是拉丁、實體名是日文。
- **Akira Yamaoka 是唯一 MB 實體名本來就用拉丁的一位**（Apple jp 顯示「山岡晃」，那是店面在地化）
  ——池中 `Akira Yamaoka`／`山岡晃` 兩種寫法**都是 0 命中，沒有重複卡**。
- **26 張全部無池中重複卡。**

## 第 12 條：**遊戲發售年 vs 原聲帶發行年（a 組）**

24 張同年、2 張跨年（ActRaiser 遊戲 1990-12-16／碟 1991-01-25，**Apple 的日期標的是遊戲上市日**；
ペルソナ5 遊戲 2016-09-15／碟 2017-01-17）。
**唱片早於遊戲 4 張**：FF IV −35 天、LIVE A LIVE −8、FF VI −8、Kingdom Hearts −1。
同日 1 張（聖剣伝説2，1993-08-06）。最晚 FF XII +76 天。
