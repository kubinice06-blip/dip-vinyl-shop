...
## 第 573 條（主線 2026-09-16，研究層 a 組交件後）：**a 組 18 張全 full，16 張以同期紙本坐實；兩張把握度低的照裁定權自行定案**

**兩張維持卡單、但把握度低（寫作層要收斂）**：
1. **Duke Pearson《Wahoo!》（BLP 4191）——全組把握度最低**。jazzdisco 年份欄寫「**1966+**」而非 1965；
   Discogs 美國原壓 **1965／1966 混雜，不滿足第 531 條「全部標同一年」**；
   a 組掃過 1964-01→1967-08 共 154 期 Cash Box，**4191 全段零命中**（同期 4188／4190／4200／4201 都有廣告或評論）。
   唯一紙本痕跡是 CB 1966-03-12 p71 芝加哥站商 Allstate 的熱賣名單。
   **裁定：無紙本可用時落到 Discogs 最早壓片＝1965，壓過 jazzdisco 的「1966+」，卡單維持 1965**；
   **正文不得寫月份與市場反應。**
2. **Pete La Roca《Basra》（BLP 4205）——全組唯一沒有同期紙本的一張**。154 期 Cash Box 對 4205／Basra／Eiderdown 零命中；
   Discogs 兩筆美國原壓乾淨標 1965、無同號干擾，**維持 1965**，把握度低於其他 16 張。

**「零命中」本身是資訊，但不是反證**：第 570 條用零命中反證《Blue John》當年未上市，是因為**同段別的號碼都有命中**；
《Wahoo!》這裡同樣是同段有、本張無，卻只降低把握度、不改年份——**差別在於有沒有另一個年份的正面證據**。
**通則：紙本零命中只能用來推翻「某年已上市」的主張，不能單獨用來建立另一個年份。**

## 第 574 條（同日）：**a 組推翻／修正上游四處**

- ⚠ **《Little Johnny C》：Discogs 美國原壓整群標 1963（＝錄音年）是錯的**——**第 550 條的正面案例**，
  CB 1964-04-04 評論 ＋ 1964-04-11「三四月新貨總表」壓過它，**年份 1964**。
- **MB 曲名錯**：該盤第 4 軌 MB 作「My **Sweet** Passion」，CB 1964 評論／jazzdisco／Apple 三邊都作
  「My **Secret** Passion」——**寫作層一律用 Secret**。
- **MB 年份＝錄音年兩張已坐實**：《Extension》MB 1964 → **實為 1967**（CB 1967-01-21 p25 Blue Note 整版廣告，
  頁腳已是 Liberty）；《Bring It Home to Me》MB 1966 → **實為 1967**（CB 1967-03-04 p42 評論，維基 3/15）。
- **補上 MB 缺的 mono 目錄號 5 張**（BLP 4191／4200／4201／4207／4188）與《Some Other Stuff》的逐軌長度（MB 未登，取自 Apple）。

## 第 575 條（同日）：**c-140 試聽補滿 30/30；a 組四張全部逐軌同序**

Little Johnny C `724873023`（6 軌無加曲）、A Chip off the Old Block `715562180`（**前 5 軌同序，6／7 軌是早期七重奏版**）、
Some Other Stuff `716361354`（4 軌無加曲）、Night of the Cookers Vol. 1 `1442950621`（2 軌無加曲；
**Vol. 2 是另一條目 `1443156966`，兩卷沒有合訂**）。主線已補進 `previews.json`。
**c-140 封面 30/30、試聽 30/30，無來源 0 張。**

a 組新抓的 Cash Box **1964-01→1965-12 共 101 期命中頁**已收進
`batch-progress/enum/cashbox-bn-1964-65-ocr.txt`（3.8 MB）。
**到此 Cash Box 的覆蓋是 1960-11 → 1967 全段 ＋ 1984-09→1985-06；1968 年起還沒有人掃。**

## 第 576 條（主線 2026-09-16，鉤子層交件後）：**中途檢查點提交會把「還沒收完的稿」寫進 repo——驗收提交是唯一的真相點**

主線為了防容器重啟，每隔一段時間把代理正在寫的檔案當「中途檢查點」提交。
c-140 鉤子層交件時發現：**那次檢查點剛好把 b 檔停在定稿前一版**（《The Rajah》一筆 note 352 字，超過 350 上限），
a 檔則剛好是定稿。**代理依指示沒有 commit，所以 repo 裡一度留著一筆超標的 note。**

**裁定（程序）**：中途檢查點提交**不具驗收效力**，它只防資料遺失。
**每一層交件後，主線一定要重跑該層的 QA 並另外提交一次「驗收版」**——
**已經有檢查點提交過，不代表工作區沒有更新的定稿。**
（「失敗與正常長得一樣」家族：**檔案已經在 repo 裡了，與檔案是定稿，長得一模一樣。**）
本次已重跑 `qa-batch hooks c140`＋`chk-hook-crossgroup c140` 全清（hook 加權 19–36、note 306–350）並提交定稿。

**鉤子層的發行年逐筆比對（第 556 條）30/30 全部相符**，含改判的 Extension 1967、Bring It Home to Me 1967、
The Empty Foxhole 1967、The Rajah 1985、Little Johnny C 1964、Joy Spring 1981。**這個關卡繼續沿用。**
