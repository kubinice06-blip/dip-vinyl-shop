(() => {
  ...
  function addStyle() {
    ...
    style.textContent = `
      ...
      .music-map-paths{display:grid;gap:7px}.music-map-path{display:grid;grid-template-columns:1fr auto;gap:10px;font-size:10px;border-bottom:1px solid var(--line,#ddd);padding-bottom:6px}.music-map-path span:last-child{color:var(--gray,#888);text-align:right}.music-map-untagged{font-size:10px;color:var(--gray,#888);padding-top:2px}.music-map-note{margin-top:10px;font-size:10px;line-height:1.7;color:var(--gray,#888)}
